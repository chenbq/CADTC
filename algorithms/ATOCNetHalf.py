...
class ATOCNetHalf(AgentBaseNet):
    """
    ...
    def step(self, obs, nearby_agents, explore=False, com_mode = 'initial', comm_top_in=None, com_flag=False):
        ...
        action = self.actor_II(torch.zeros_like(thought), thought_after)
    ...
    def get_target_action(self, obs, comm_top):
        ...
        action = self.actor_II_target(torch.zeros_like(thought), thought_after)
